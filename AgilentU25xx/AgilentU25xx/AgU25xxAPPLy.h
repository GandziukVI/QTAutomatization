...
public:
    ...
    QString cmdApplySineWave(double amplitude, double offset, QVector<AgU25xxAnalogOutput::AOChannels> channel);
    QString cmdApplySquareWave(double amplitude, double offset, AgU25xxAnalogOutput::AOChannels channel);
    QString cmdApplySquareWave(double amplitude, double offset, QVector<AgU25xxAnalogOutput::AOChannels> channel);
    QString cmdApplySawToothWave(double amplitude, double offset, AgU25xxAnalogOutput::AOChannels channel);
    QString cmdApplySawToothWave(double amplitude, double offset, QVector<AgU25xxAnalogOutput::AOChannels> channel);
    QString cmdApplyTriangleWave(double amplitude, double offset, AgU25xxAnalogOutput::AOChannels channel);
    QString cmdApplyTriangleWave(double amplitude, double offset, QVector<AgU25xxAnalogOutput::AOChannels> channel);
    QString cmdApplyNoise(double amplitude, double offset, AgU25xxAnalogOutput::AOChannels channel);
    QString cmdApplyNoise(double amplitude, double offset, QVector<AgU25xxAnalogOutput::AOChannels> channel);
    QString cmdApplyUser(double amplitude, double offset, AgU25xxAnalogOutput::AOChannels channel);
    QString cmdApplyUser(double amplitude, double offset, QVector<AgU25xxAnalogOutput::AOChannels> channel);
};
