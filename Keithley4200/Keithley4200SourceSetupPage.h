...
public:
    ...
    QString cmdConfListSweep(SMUSourceMode sourceMode, const unsigned int channelID, SMUMasterOrSlaveMode masterOrSlaveMode, double complianceValue, const QVector<double>& listValues);
